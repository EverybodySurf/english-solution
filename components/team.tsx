...
export default function TeamSection() {
    return (
        <section className="py-12 md:py-20 dark:bg-transparent" id="team">
            <div className="mx-auto max-w-5xl px-6">
                {/*<span className="text-caption -ml-6 -mt-3.5 block w-max bg-gray-50 px-6 dark:bg-gray-950">Team</span>*/}
                <div className="mt-12 gap-4 sm:grid sm:grid-cols-2 md:mt-16">
                    ...
                    <div className="grid gap-x-6 gap-y-12 sm:grid-cols-2 lg:grid-cols-2">
                        {members.map((member, index) => (
                            <div key={index} className="group overflow-hidden">
                                <img className="h-126 w-full rounded-md object-cover object-bottom grayscale transition-all duration-500 hover:grayscale-0 group-hover:h-[30rem] group-hover:rounded-xl" src={member.avatar} alt="team member" width="826" height="1239" />
